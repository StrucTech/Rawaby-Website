...
export default function ClientDataRequestsPage() {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">طلبات البيانات</h1>
          <p className="text-gray-600 mb-6">هنا تظهر الطلبات من المشرفين التي تحتاج ردك أو رفع ملفات</p>
        ...
        {/* رابط للعودة للرسائل القديمة */}
        <div className="mt-4 text-center">
          <a 
            href="/messages" 
            className="text-blue-600 hover:text-blue-800 text-sm"
          >
            ← العودة لرسائل المشرفين الأخرى
          </a>
        </div>
      </div>
    </div>
